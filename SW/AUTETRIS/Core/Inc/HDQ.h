...
***************************************************/
#define HDQ_DELAY_FAIL_TRIES    200

/**************************
 * HDQ Default timings
**************************/
#define HDQ_DELAY_THW1			32	// 32 - 66uS
#define HDQ_DELAY_THW0			70	// 70 - 145uS

#define HDQ_DELAY_TDW1			1	// 0.5 - 50us
#define HDQ_DELAY_TDW0			86	// 86 - 145uS
#define HDQ_DELAY_TCYCD			190	// 190 min

#define HDQ_DELAY_TB            190 /* Min: 190uS */
#define HDQ_DELAY_TBR           40  /* Min: 40uS */
#define HDQ_DELAY_TCYCH         190 /* Min: 190uS Max: 250uS*/
